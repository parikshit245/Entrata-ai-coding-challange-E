  ...
  return (
    <div className="flex items-center gap-2">
      <label
        ...
        className="whitespace-nowrap text-xs font-medium text-[var(--text-secondary)]"
      >
        Sort by:
      </label>
      <div className="relative">
        <select
          ...
          className="appearance-none rounded-[var(--radius-sm)] border border-[var(--border)] bg-[var(--surface)] py-1.5 pl-3 pr-8 text-xs font-medium text-[var(--text-primary)] shadow-sm transition-colors hover:border-[var(--border-strong)] focus:border-[var(--accent)] focus:outline-none focus:ring-2 focus:ring-[var(--accent-subtle)]"
