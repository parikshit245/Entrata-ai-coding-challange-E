        ...
        <div className="flex items-center gap-8">
          <a href="#" className="flex items-center gap-2 text-decoration-none">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] font-semibold tracking-widest uppercase text-[var(--text-muted)] -mt-1">
                Store
              </span>
            </div>
          </a>
          ...
          <nav className="hidden md:flex items-center gap-6 text-xs font-medium text-[var(--text-secondary)]">
            <a href="#catalog-section" className="text-[var(--accent)] transition-colors hover:text-[var(--accent-hover)] font-semibold">
              All Products
            </a>
            <button
              type="button"
